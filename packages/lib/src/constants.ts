...
export const REPORTS_CONSTANTS = {
  ...
  MOBILE_CREATE_SCREEN: {
    ...
    TOAST_MESSAGES: {
      ...
      DRAFT_SAVING: '下書き保存中...',
      DRAFT_SAVING_SUBTITLE: '少々お待ちください',
      DRAFT_SUCCESS: '下書きを保存しました',
      DRAFT_SUCCESS_SUBTITLE: '詳細ページに移動します',
      NETWORK_ERROR: 'ネットワークエラーが発生しました',
  ...
  MOBILE_DETAIL_SCREEN: {
    ...
    ALERTS: {
      ...
      DELETE_TITLE: '削除確認',
      DELETE_MESSAGE: 'この日報を削除しますか？この操作は取り消せません。',
      DELETE_SUCCESS: '日報を削除しました',
      DELETE_ERROR: (message: string) => `削除に失敗しました: ${message}`,
      CANCEL: 'キャンセル',
    },
    APPROVAL_HISTORY: {
